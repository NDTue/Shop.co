...
function Header({ props }) {
    ...
    return (
        <header className='fixed w-full bg-white shadow z-20'>
            {/* Notification */}
            <div className='py-2 md:py-4 text-center text-white bg-black'>
                <div className="relative mx-auto max-w-96 md:max-w-[78rem] font-thin text-sm md:text-base">
                    Sign up and get 20% off to your first order.
                    <a className='ml-2 underline underline-offset-4' href="">Sign Up Now</a>
                    {/* Close button */}
                    <button className='absolute right-0 hidden md:inline-block'>
                        ...
                        <ul className='md:flex left-0 flex-row items-center w-full gap-6 py-6 transition-all duration-200 ease-in-out
                            ...
                            <li className='relative group py-2 md:py-0 px-3 md:px-0'>
                                ...
                                <ul className='group-hover:block hidden absolute top-10 left-2 bg-black w-28
                                    ...
                                    <li className='hover:bg-gray-900 text-white'>
                                        <a href="#" className='block py-2 px-3'>Men</a>
                                    </li>
                                    <li className='hover:bg-gray-900 text-white'>
                                        <a href="#" className='block py-2 px-3'>Women</a>
                                    </li>
                                    <li className='hover:bg-gray-900 text-white'>
                                        <a href="#" className='block py-2 px-3'>Kids</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <li className='relative group py-2'>
                            ...
                            <ul className='group-hover:block hidden absolute top-6 -left-2 bg-white w-28
                                ...
                                <li className='hover:bg-slate-100'>
                                    <a href="#" className='block p-2'>Men</a>
                                </li>
                                <li className='hover:bg-slate-100'>
                                    <a href="#" className='block p-2'>Women</a>
                                </li>
                                <li className='hover:bg-slate-100'>
                                    <a href="#" className='block p-2'>Kids</a>
                                </li>
                            </ul>
                        </li>
