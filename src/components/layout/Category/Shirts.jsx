...
function Shirts(props) {
    ...
    // Lọc sp theo category = shirt
    const filteredProducts = products.filter(product => product.category.toLowerCase() === 'shirt')
            ...
            <main className='pb-5 md:pb-10'>
                    ...
                    <div className='flex flex-row justify-between items-center md:gap-10 max-w-96 md:max-w-[78rem] my-0 mx-auto xl:mx-auto md:ml-16 md:mr-16'>
                        <ol className="flex items-center whitespace-nowrap">
                            <Link to='/' className="inline-flex items-center">
                                <span className="flex items-center text-sm text-gray-500 hover:text-black focus:outline-hidden focus:text-blue-600" href="#">
                                    Home
                                </span>
                ...
                <section className="max-w-96 md:max-w-[78rem] mx-auto px-4">
                    <div className="flex justify-between items-center mb-5">
                        <h1 className="text-4xl md:text-5xl font-bold">Shirts</h1>
